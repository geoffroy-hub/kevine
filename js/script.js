...
function showFinaleWarning() {
	...
	warn.innerHTML = "<div style='font-size:clamp(2rem,8vw,5rem);font-weight:900;color:#fff;" +
		...
		"<div style='font-size:clamp(1rem,3vw,1.8rem);color:#ffb6c1;margin-top:8px;letter-spacing:2px;'>Pour toi Kevine 💗</div>";
...
const frenchWishes = [
	...
	"🌟 Tu es une personne exceptionnelle, Kevine",
	...
	"🎀 Bonne fête Kevine, tu le mérites tellement !",
	...
	"🕊️ Paix, amour et bonheur pour toi Kevine",
...
function showScrollingWishes() {
	...
	header.textContent = "💗 Nos vœux pour toi Kevine 💗";
...
function showHeartGalleryEnd() {
	...
	msg.innerHTML = "\u2728 Que cette journ\u00E9e soit remplie de bonheur,<br>de joie et d'amour infini.<br>" +
		"<strong style='color:#ff69b4;'>Nous t'aimons Kevine\u00A0! \uD83D\uDC97</strong>";
...
function showGrandFinal(overlay) {
	...
	grand.innerHTML =
		...
		"<strong style=\'color:#ffd700;\'>Bonne f\u00EAte Kevine \uD83D\uDC97</strong>" +
		"</div>";
